export default [
  {
    id: 'javascript-announcement',
    title: 'Netscape and Sun announce JavaScript',
    url: 'https://web.archive.org/web/20020606002913/http:/wp.netscape.com/newsref/pr/newsrelease67.html',
  },
  {
    id: 'future-of-programming',
    title: 'Bret Victor − The Future of Programming',
    url: 'https://www.youtube.com/watch?v=8pTEmbeENF4',
    about: `"We don't know what programming is"`,
  },
  {
    id: 'cascading-cache-invalidation',
    title: 'Cascading Cache Invalidation',
    url: 'https://philipwalton.com/articles/cascading-cache-invalidation/',
    about:
      'An interesting article about the challenges of caching javascript files',
  },
  {
    id: 'queues-and-microservices',
  ...
  },
  {
    ...
    url: 'https://www.slideshare.net/icecrime/building-software-the-lessons-from-open-source',
